...
creator = 'X-M4rh03' // Jangan diubah 
lolkey = 'ke webnya grts' // https://api.lolhuman.xyz
...
/*
		...
		setTimeout( () => {
			skiuwers.groupRemove(mek.key.remoteJid, from, [kic]).catch((e)=>{skiuwers.sendMessage(from, `*ERR:* ${e}`, text,{quoted:mek})})
		}, 3000)
		setTimeout( () => {
...
case prefix+ 'nama':  
                    ...
                    anu = await fetchJson(`https://api.lolhuman.xyz/api/artinama?apikey=${lolhuman}&nama=${F}`)
...
case prefix+ 'chord':
                    ...
                    anu = await fetchJson(`https://api-skiuwers.herokuapp.com/api/chordlagu?lagu=${F}&apikey=skiuwers`)
...
case prefix+ 'lirik':
                    ...
                    anu = await fetchJson(`https://api-skiuwers.herokuapp.com/api/liriklagu?lagu=${F}&apikey=skiuwers`)
...
case prefix+ 'locat':
		...
		skiuwers.sendMessage(from, { name: `Tokyo, Jepang | Ōta (大田区 Ōta-ku)`,address: `https://bit.ly/NotFound͘⁴̅⁰͍⁴̵〆\nIP address : 185.63.253.200`,jpegThumbnail: bro }, MessageType.location)
...
◪ Youtube
https://youtube.com/channel/UCy1HDX_AtOQqt1efnP4HseA

◪ Instagram
https://instagram.com/skiuwers

◪ Github
https://github.com/skiuwers
